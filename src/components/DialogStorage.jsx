            ...
            <DialogContent className="sm:max-w-[500px] rounded-lg shadow-lg border border-gray-200">
                ...
                <div className="grid gap-4 py-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Input id="id" placeholder="Nhập mã sản phẩm" className="border rounded-md p-2" />
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Input id="name" placeholder="Nhập tên sản phẩm" className="border rounded-md p-2" />
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Input id="costPrice" placeholder="Nhập giá vốn" className="border rounded-md p-2" />
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Input id="salePrice" placeholder="Nhập giá bán" className="border rounded-md p-2" />
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Input id="stock" placeholder="Nhập số lượng tồn kho" className="border rounded-md p-2" />
                    </div>
                </div>
